...
<%
    ...
    try {
        ...
        String sql = "SELECT password FROM user WHERE name=? AND id=? AND phonenumber=?";
...
%>
            <script>
                alert('해당하는 정보로 등록된 사용자가 없습니다.');
                window.location.href = "../html/searchPw.html";
            </script>
<%
        }
    } catch (Exception e) {
